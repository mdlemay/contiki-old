...
build() {
    ...
    export CFLAGS_FOR_TARGET="-Os -m32 -march=i586 -mtune=i586 -fno-stack-protector -fno-asynchronous-unwind-tables -fno-unwind-tables -DPREFER_SIZE_OVER_SPEED"
    export CXXFLAGS_FOR_TARGET="-Os -m32 -march=i586 -mtune=i586 -fno-stack-protector -fno-asynchronous-unwind-tables -fno-unwind-tables -DPREFER_SIZE_OVER_SPEED"
